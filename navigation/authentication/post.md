...
<div class="sidebar">
    <button class="sidebar-button" data-group-id="1" data-channel-id="22">Adventure Play House</button>
    <button class="sidebar-button" data-group-id="1" data-channel-id="23">Sylvanian Family Restaurant House</button>
    <button class="sidebar-button" data-group-id="2" data-channel-id="24">Magical Mermaid Castle House</button>
    <button class="sidebar-button" data-group-id="2" data-channel-id="25">Woody School House</button>
    <button class="sidebar-button" data-group-id="3" data-channel-id="26">Spooky Surprise Haunted House</button>
    <button class="sidebar-button" data-group-id="3" data-channel-id="27">Brick Oven Bakery House</button>
</div>
