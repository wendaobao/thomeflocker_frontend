...
<script>
  ...
  const correctAnswer = 'Stay, You on my good? A run more fast you go strong!';
  let attemptsLeft = 3;
  let isLocked = false;
  ...
  function showRetryButton() {
    feedback.innerHTML = '<button class="button retry" onclick="retry()">Retry Level Five</button>';
  }
